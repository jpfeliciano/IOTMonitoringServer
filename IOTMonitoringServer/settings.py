...
https://docs.djangoproject.com/en/4.0/ref/settings/ALLOWED_HOSTS
"""
...
ALLOWED_HOSTS = ["localhost", "52.207.169.130"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "107.23.200.76",  # Dirección IP de la base de datos
